...
public class DataHelper {
    ...
    /* renamed from: iv */
    private static final byte[] f1389iv = {10, 1, 11, 5, 4, TType.f577m, 7, 9, 23, 3, 1, 6, 8, 12, TType.f575k, 91};
    ...
    public static byte[] encrypt(byte[] bArr, byte[] bArr2) {
        ...
        instance.init(1, new SecretKeySpec(bArr2, "AES"), new IvParameterSpec(f1389iv));
        return instance.doFinal(bArr);
    }

    public static byte[] decrypt(byte[] bArr, byte[] bArr2) {
        Cipher instance = Cipher.getInstance("AES/CBC/PKCS7Padding");
        instance.init(2, new SecretKeySpec(bArr2, "AES"), new IvParameterSpec(f1389iv));
        return instance.doFinal(bArr);
    }
