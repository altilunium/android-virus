...
public class Envelope {
    ...
    private Envelope(byte[] bArr, String str, byte[] bArr2) {
        ...
        this.mEntity = DeflaterHelper.m1422a(bArr);
    ...
    public byte[] toBinary() {
        ...
        ajVar.mo300a(this.mVersion);
        ajVar.mo305b(this.mAddress);
        ajVar.mo309c(DataHelper.toHexString(this.mSignature));
        ajVar.mo299a(this.mSerialNo);
        ajVar.mo304b(this.mTimestamp);
        ajVar.mo308c(this.mLength);
        ajVar.mo302a(this.mEntity);
        ajVar.mo313d(this.encrypt ? 1 : 0);
        ajVar.mo314d(DataHelper.toHexString(this.mGuid));
        ajVar.mo319e(DataHelper.toHexString(this.mChecksum));
        try {
            return new TSerializer().mo398a(ajVar);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public void export(Context context) {
        ...
        try {
            ...
            if (imprintProperty != null) {
                jSONObject2.put(UMCommonContent.f358g, HelperUtils.getUmengMD5(imprintProperty));
            }
